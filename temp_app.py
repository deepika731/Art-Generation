...
def success():  
    if request.method == 'POST':  
        ...
        style_path = f2.filename
        content_path = f1.filename
        ...
        full_filename = {}
        full_filename[0] = os.path.join(app.config['UPLOAD_FOLDER'], f1.filename)
        full_filename[1] = os.path.join(app.config['UPLOAD_FOLDER'], f2.filename)
        full_filename[2] = os.path.join(app.config['UPLOAD_FOLDER'], 'output.jpg')
